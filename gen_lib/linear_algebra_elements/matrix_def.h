...
typedef Matrix##UCN Matrix##UCN##Ref;                                                                                                               \
                                                                                                                                                    \
...
DECLARE_STRUCT_TYPE(Matrix##UCN, Matrix##UCN);                                                                                                      \
                                                                                                                                                    \
static inline Matrix##UCN##Ref getMatrix##UCN##OnBuffer(const Matrix##UCN * origin, int lines_start, int lines_finish, int lines, int columns);     \
                                                                                                                                                    \
...
{                                                                                                                                                                  \
    ...
    destruct##UCN(&mat->value_beyond_allocked_space);                                                                                                              \
                                                                                                                                                                   ...
                                                                                                                                                                   \
static inline Matrix##UCN##Ref getMatrix##UCN##OnBuffer(const Matrix##UCN * origin, int lines_start, int columns_start, int lines, int columns)                    \
{                                                                                                                                                                  \
    Matrix##UCN##Ref res;                                                                                                                                          \
                                                                                                                                                                   \
...
{                                                                                                                                                                  \
    ...
    Matrix##UCN##Ref A11 = getMatrix##UCN##OnBuffer(&A, 0, 0, half_size_in_mult, half_size_in_mult);                                                               \
    Matrix##UCN##Ref A12 = getMatrix##UCN##OnBuffer(&A, 0, half_size_in_mult, half_size_in_mult, half_size_in_mult);                                               \
    Matrix##UCN##Ref A21 = getMatrix##UCN##OnBuffer(&A, half_size_in_mult, 0, half_size_in_mult, half_size_in_mult);                                               \
    Matrix##UCN##Ref A22 = getMatrix##UCN##OnBuffer(&A, half_size_in_mult, half_size_in_mult, half_size_in_mult, half_size_in_mult);                               \
                                                                                                                                                                   \
    Matrix##UCN##Ref B11 = getMatrix##UCN##OnBuffer(&B, 0, 0, half_size_in_mult, half_size_in_mult);                                                               \
    Matrix##UCN##Ref B12 = getMatrix##UCN##OnBuffer(&B, 0, half_size_in_mult, half_size_in_mult, half_size_in_mult);                                               \
    Matrix##UCN##Ref B21 = getMatrix##UCN##OnBuffer(&B, half_size_in_mult, 0, half_size_in_mult, half_size_in_mult);                                               \
    Matrix##UCN##Ref B22 = getMatrix##UCN##OnBuffer(&B, half_size_in_mult, half_size_in_mult, half_size_in_mult, half_size_in_mult);                               \
                                                                                                                                                                   \
                                                                                                                                                                   \
    ...
    Matrix##UCN M7 = multMatrix##UCN##RV(subMatrix##UCN(&A12, &A22), addMatrix##UCN(&B21, &B22));                                                                  \
                                                                                                                                                                   ...
                                                                                                                                                                   \
    Matrix##UCN res = defaultMatrix##UCN(a->lines, b->columns, null##UCN());                                                                                       \
    Matrix##UCN##Ref C11 = getMatrix##UCN##OnBuffer(&res, 0, 0, half_size_in_mult, half_size_in_mult);                                                             \
    Matrix##UCN##Ref C12 = getMatrix##UCN##OnBuffer(&res, 0, half_size_in_mult, half_size_in_mult, b->columns - half_size_in_mult);                                \
    Matrix##UCN##Ref C21 = getMatrix##UCN##OnBuffer(&res, half_size_in_mult, 0, a->lines - half_size_in_mult, half_size_in_mult);                                  \
    Matrix##UCN##Ref C22 = getMatrix##UCN##OnBuffer(&res, half_size_in_mult, half_size_in_mult, a->lines - half_size_in_mult, b->columns - half_size_in_mult);     \
                                                                                                                                                                   \
                                                                                                                                                                   \
